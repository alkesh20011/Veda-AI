# Veda-AI
Veda-AI: Multilingual Vedic RAG A professional Retrieval-Augmented Generation (RAG) system for querying ancient Vedic texts. Built with LangChain v1.x, ChromaDB, and Ollama. Features local LLM support, multilingual embeddings, and real-time streaming.
...
Veda-AI is a professional-grade **Retrieval-Augmented Generation (RAG) system designed to provide accurate, context-aware answers from ancient Vedic scriptures. By combining the power of **Llama 3** with a vector-indexed library of 7+ foundational books, the Oracle acts as a bridge between ancient wisdom and modern AI.
 ...
 Key Features
* **100% Local & Private:** Powered by Ollama—your data and queries never leave your machine.
